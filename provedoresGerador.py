...
def generateComputerService():
    ...
    data["userRequirements"][0]["availability"] = 1 + round(random.uniform(98,99),3)
...
for numberOfProviders in range(20,21,1):
    data = []
    ...
    nomeArq = 'ProvidersACOKP'+ str(numberOfProviders) + '-'+ str(numberOfServices) + '.json'
